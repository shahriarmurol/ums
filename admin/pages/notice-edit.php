<?php 
    ...
    $id = $_REQUEST['nuid']; //for show data
    //notice
    if(isset($_POST['addNotice'])){
      ...
      if(!empty($notice_text AND $notice_file)){
        ...
        echo "Notice text and file must not be Empty";  
    }
  }
?>
<!DOCTYPE html>
                ...
                <div class="col-lg-12">
                    ...
                    <form  role="form" action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <textarea name="notice" id="notice" cols="30" rows="10"  class="form-control" placeholder="Type Notice Here"><?= $data['notice']; ?></textarea>
                        </div>
                        <div class="form-group">
                            <label for="file">File : <?= $data['notice_file']; ?> </label>
