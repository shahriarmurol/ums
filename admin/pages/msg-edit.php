<?php
    ...
    if(isset($_POST['msg_update'])){
        ...
        if(!empty($name)){
            $update = "UPDATE comments SET com_id='', com_name='$name', com_email='$email', com_subject='$sub', com_message='$msg' WHERE com_id='$id' ";
...
<body>
 ...
 <!-- content goes here -->
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Messages</h1>
                    <?php 
                          // $slt ="SELECT * FROM comments WHERE com_id='$id'";
                          // $qre = mysqli_query($DBC, $slt);
                          // $data=mysqli_fetch_array($qre);
                    ...
                    <form action="" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="msg_name" id="name" value="<?= $data['com_name']; ?>" placeholder="Name" class="form-control" required="1" />
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="text" name="msg_email" id="email" value="<?= $data['com_email']; ?>" placeholder="Email Address" class="form-control" required="1" />
                        </div>
                        <div class="form-group">
                            <label for="subject">Subject</label>
                            <input type="text" name="msg_subject" id="subject" value="<?= $data['com_subject']; ?>" placeholder="Subject " class="form-control" required="1" />
                        </div>
                        <div class="form-group">
